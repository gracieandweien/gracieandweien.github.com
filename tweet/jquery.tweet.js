(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["violasong"],              // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
    ...
    return this.each(function(){
      ...
      $.getJSON(url, function(data){
        ...
        $.each(data.results, function(i,item){
          ...
          var text = '<span class="tweet_text">' +$([item.text]).linkUrl().linkUser().linkHash().makeHeart()[0]+ '</span>';
